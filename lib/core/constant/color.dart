...
class AppColor {
  ...
  static const Color blue = Color(0xff669AD4);
  static const Color blueAccent = Color(0xffDCE8F2);
  static const Color black = Color(0xff000000);
  static const Color greylight = Color(0xffB7B7B7);
  static const Color orangelight = Color(0xffFFC5B8);
  static const Color bluelight = Color(0xff2F88FF);
  static const Color green = Color(0xff25A85E);
