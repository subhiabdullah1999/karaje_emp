...
class ToCitiesDropDown extends StatelessWidget {
  final String labelText;
  final RxInt controller;

  const ToCitiesDropDown({
    super.key,
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        '${addNewTripController.cities.isEmpty ? 'لا يوجد محافظات' : addNewTripController.selectedToCity == 0.obs ? 'اختر المحافظة' : addNewTripController.cities[addNewTripController.selectedToCityId.toInt()]['name']}',
...
void _showDropdownMenu(BuildContext context) {
  ...
  showMenu(
    ...
    //initialValue: addNewTripController.selectedToCity.value,
  ).then((value) {
    var cities = addNewTripController.cities[value];
    if (value != null) {
      addNewTripController.updateSelectedToCity(
        cities['id'],
      );
      addNewTripController.updateSelectedToCityId(
        value,
      );
      //print('to city id : ${addNewTripController.selectedToCity.value}');
    }
  });
}
