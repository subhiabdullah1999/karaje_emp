...
class EndTimeTextField extends StatelessWidget {
              ...
              child: GestureDetector(
                onTap: () async {
                  ...
                  if (dateTime != null) {
                    ...
                    addNewTripController.updateSelectedEndTime(dateTime);
                ...
                child: Container(
                  ...
                  child: Text(
                    "${addNewTripController.selectedSEndDate.hour.toString().padLeft(2, '0')}:${addNewTripController.selectedSEndDate.minute.toString().padLeft(2, '0')}",
